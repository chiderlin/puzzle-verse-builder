...
export const CrosswordGrid = ({ 
  ...
  return (
    <div className="max-w-xl mx-auto px-4 py-4">
      <div className="text-center mb-4">
        <div className="flex justify-center gap-4 items-center">
          <img 
            ...
            className="w-8 h-8"
          />
          <h1 className="text-2xl font-black tracking-tight">CROSSWORD PUZZLE</h1>
          <img 
            src="/lovable-uploads/c6fa1836-b744-4791-a522-0d9aff5c5f6b.png" 
            alt="Castle" 
            className="w-8 h-8"
      ...
      <div 
        ref={gridRef} 
        className="grid gap-px bg-gray-900 p-0.5 rounded-lg shadow-xl max-w-lg mx-auto"
        style={{
            ...
            >
              {cell.letter !== "" && (
                <>
                  {cell.number && (
                    <span 
                      className="absolute top-0.5 left-0.5 text-[8px] font-bold text-gray-900"
                    >
                      {cell.number}
                    </span>
                  )}
                  <input
                    ...
                    maxLength={1}
                    className={`
                      w-full h-full text-center text-sm font-bold
